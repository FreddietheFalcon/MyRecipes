      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 8, marginBottom: 28 }}>
          {["email", "otp", "newpassword"].map((s, i) => (
            <div key={s} style={{
              ...
              background: step === s ? "#7ed321" :
                (["email", "otp", "newpassword"].indexOf(step) > i ? "#b8e87a" : "#e4e9ef"),
        ...
        {step === "email" && (
          <form onSubmit={handleRequestReset}>
            <p style={{ fontSize: 13, color: "#b0b8c1", fontWeight: 600, marginBottom: 20 }}>
              Enter your account email and we'll send you a reset code.
            </p>
            <div style={{ marginBottom: 24 }}>
              <label style={labelStyle}>Email</label>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                required placeholder="you@email.com" style={inputStyle} autoComplete="username" />
            </div>
            ...
            <p style={{ textAlign: "center", marginTop: 20, fontSize: 13, color: "#b0b8c1", fontWeight: 600 }}>
              <Link to="/login" style={{ color: "#5aaa10", fontWeight: 800, textDecoration: "none" }}>← Back to Login</Link>
            </p>
          </form>
        )}
        ...
        {step === "otp" && (
          <form onSubmit={handleVerifyOtp}>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <input type="text" value={otp} onChange={(e) => { setOtp(e.target.value); setErrorMsg(""); }}
          ...
          <form onSubmit={handleResetPassword}>
            <div style={{ marginBottom: 16 }}>
              ...
              <input type="password" value={newPassword}
                onChange={(e) => { setNewPassword(e.target.value); setShowRules(true); setErrorMsg(""); }}
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <input type="password" value={confirm}
                ...
                style={{ ...inputStyle, borderColor: confirm && confirm !== newPassword ? "#e5333a" : "#e4e9ef" }}
